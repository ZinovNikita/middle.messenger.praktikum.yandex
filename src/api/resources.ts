...
type ResourcesType = {
    ...
    $add: (file:File) => Promise<Obj>,
}
export default class Resources extends ApiBase implements ResourcesType {
    ...
    public $add (file:File):Promise<Obj> {
        const body:FormData = new FormData();
        body.append('resource', file);
        return fetch2.$post(`${this.host}/api/v2/resources`,{ headers: undefined, body }) as Promise<Obj>
    }
}
